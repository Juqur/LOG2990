...
describe('UndoRedoService', () => {
    ...
    describe('undo', () => {
        ...
        it('should return an empty canvas when undoPointer is 0', () => {
            const expectedCanvas = { defaultCanvas: document.createElement('canvas'), differenceCanvas: document.createElement('canvas') };
        ...
        it('should return the action when undoPointer is superior than 0', () => {
            ...
            const differenceCanvas = {} as unknown as HTMLCanvasElement;
            UndoRedoService.undoPointer = 1;
            UndoRedoService.canvasStack.push({ defaultCanvas, differenceCanvas });
            const action = UndoRedoService.undo();
            expect(action).toEqual({ defaultCanvas, differenceCanvas });
        });
    });
    ...
    describe('redo', () => {
        ...
        beforeEach(() => {
            ...
            UndoRedoService.undoPointer = 1;
            UndoRedoService.redoStack.push({ defaultCanvas, differenceCanvas });
        });
